package com.u1mobis.dashboard_backend.infrastructure.messaging;
...
import com.u1mobis.dashboard_backend.application.analytics.AnalyticsApplicationService;
    ...
    public void processMQTTMessage(String topic, String payload) {
        try {
            ...
            if (topic.contains("/production/started")) {
                ...
                // 생산 시작 처리
                productionApplicationService.startProduction(
                    companyName,
                    lineId,
                ...
                // 생산 완료 처리
                productionApplicationService.completeProduction(
                    companyName,
                    lineId,
                    data.get("product_id").asText(),
                ...
                // KPI 데이터 처리
                analyticsApplicationService.processKPIData(
                    companyName,
                    lineId,
                ...
                // 환경 데이터 처리
                analyticsApplicationService.saveEnvironmentData(
                    companyName,
                ...
                // 컨베이어 제어 처리
                equipmentApplicationService.saveConveyorStatus(
                    companyName,
                    lineId,
